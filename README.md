...
If you are using this library in one of your projects, add it in this list. :sparkles:
 ...
 - [`nexusmods.js`](https://nexusmods-js.github.io/modules/_nexusmods_js_.html) (by AlexejheroYTB)—Gets information about mods from nexusmods.com
 - [`showdown-highlight`](https://github.com/Bloggify/showdown-highlight#readme) (by Bloggify)—A Showdown extension for highlight the code blocks.
 - [`static-gfm`](https://github.com/nova706/static-gfm#readme) (by David Hamilton)—Generate a static HTML from markdown using GitHub Flavored Markdown
